...
function conectar() {
      ...
      try {
        ...
        //AwardSpace
        $parts = (parse_url(getenv('DATABASE_URL') ?: 'mysql://2872262_daw:mjcrlvj#21@db22.awardspace.net:3306/2872262_daw'));
        extract($parts);
        $path = ltrim($path, "/");
        $dbh = new PDO("mysql:host={$host};port={$port};dbname={$path}", "2872262_daw", "mjcrlvj#21");          
