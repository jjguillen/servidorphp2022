<?php
  ...
  class VistaProfesor extends Vista {
        ...
        /**
         * Renderiza la pantalla de login de los profesores
         */
        public function renderLogin($mensajeError) {
?>            
            <!doctype html>
            <html lang="en">
              <head>
              ...
              <body class="text-center">
                ...
                <div class="container">
                    ...
                    <form action="enrutador.php" method="post">
                        ...
                        <a href="enrutador.php?accion=registro"><button class="w-100 btn btn-lg btn-primary" type="button">Regístrate</button></a>
                    </form>
